...
class MemoryTools:
    ...
    async def save_memory(
        self, title: str, content: str, summary: str | None = None, tags: list[str] | None = None
    ) -> dict[str, Any]:
    ...
    async def update_memory(
        ...
        return {"memory_id": memory_id, "updated_fields": updated_fields}

    async def remove_memory(self, memory_id: str) -> dict[str, Any]:
        cascade_stats = await self.db.delete_memory(memory_id)

        return {"memory_id": memory_id, "deleted": True, "cascade_deleted": cascade_stats}
    ...
    async def search_memory(
        ...
        for memory in memories:
            ...
            item = {
                ...
                "related": [
                    {"id": r["other_id"], "weight": round(r["weight"], 2), "distance": r["distance"]} for r in related
                ],
            }
    ...
    async def add_tag(self, memory_id: str, tag_name: str) -> dict[str, Any]:
        ...
        return {"tag_id": tag_id, "memory_id": memory_id, "tag_name": tag_id, "created_at": created_at}

    async def add_relation(self, memory_id_1: str, memory_id_2: str, weight: float = 0.5) -> dict[str, Any]:
