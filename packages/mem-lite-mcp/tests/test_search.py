...
async def test_search_by_content(memory_tools):
    ...
    await memory_tools.save_memory("Title A", "This memory contains the word asyncio")
...
async def test_search_with_depth_1(memory_tools):
    ...
    await memory_tools.save_memory("Memory 1", "Content about Python")

    result = await memory_tools.search_memory("Python", depth=1)
...
async def test_search_with_depth_2(memory_tools):
    ...
    result = await memory_tools.search_memory("Python", depth=2)
...
async def test_search_with_limit(memory_tools):
    ...
    result = await memory_tools.search_memory("Python", limit=2)
...
async def test_search_with_tags_filter(memory_tools):
    ...
    await memory_tools.save_memory("Python Advanced", "Content about advanced Python", tags=["python", "advanced"])

    result = await memory_tools.search_memory("Python", tags_filter=["python"])
...
async def test_search_max_memories_per_result(memory_tools):
    ...
    result = await memory_tools.search_memory("Python", max_memories_per_result=1)
...
async def test_search_max_relations_per_memory(memory_tools):
    ...
    result = await memory_tools.search_memory("Python", max_relations_per_memory=2)
