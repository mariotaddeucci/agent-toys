...
class TestSearchMemory:
    ...
    async def test_search_basic(self, memory_tools):
    ...
    async def test_search_by_content(self, memory_tools):
    ...
    async def test_search_with_depth_1(self, memory_tools):
    ...
    async def test_search_with_depth_2(self, memory_tools):
    ...
    async def test_search_with_limit(self, memory_tools):
    ...
    async def test_search_with_offset(self, memory_tools):
    ...
    async def test_search_with_tags_filter(self, memory_tools):
    ...
    async def test_search_empty_query(self, memory_tools):
    ...
    async def test_search_no_results(self, memory_tools):
    ...
    async def test_search_max_memories_per_result(self, memory_tools):
    ...
    async def test_search_max_relations_per_memory(self, memory_tools):
    ...
    async def test_search_response_structure(self, memory_tools):
