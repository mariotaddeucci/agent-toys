...
class TestAddTag:
    """Test suite for add_tag tool."""

    async def test_add_tag_basic(self, sample_memory, memory_tools):
    ...
    async def test_add_tag_multiple(self, memory_tools):
    ...
    async def test_add_tag_normalization(self, sample_memory, memory_tools):
    ...
    async def test_add_tag_duplicate(self, memory_tools):
    ...
    async def test_add_tag_special_characters(self, sample_memory, memory_tools):
    ...
    async def test_add_tag_empty_name(self, sample_memory, memory_tools):
...
class TestAddRelation:
    """Test suite for add_relation tool."""

    async def test_add_relation_basic(self, memory_tools):
    ...
    async def test_add_relation_bidirectional(self, memory_tools):
    ...
    async def test_add_relation_weight_min(self, memory_tools):
    ...
    async def test_add_relation_weight_max(self, memory_tools):
    ...
    async def test_add_relation_weight_mid(self, memory_tools):
    ...
    async def test_add_relation_invalid_weight_negative(self, memory_tools):
    ...
    async def test_add_relation_invalid_weight_over_one(self, memory_tools):
    ...
    async def test_add_relation_same_memory(self, memory_tools):
    ...
    async def test_add_relation_update_weight(self, memory_tools):
        """Test updating weight of existing relation."""
        mem1 = await memory_tools.save_memory("Memory 1", "Content 1")
        mem2 = await memory_tools.save_memory("Memory 2", "Content 2")
        
        # Add initial relation
        result1 = await memory_tools.add_relation(mem1['memory_id'], mem2['memory_id'], weight=0.5)
        
        # Update weight
        result2 = await memory_tools.add_relation(
            mem1['memory_id'],
            mem2['memory_id'],
            weight=0.9
        )
